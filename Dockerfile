...
LABEL org.opencontainers.image.url="https://hub.docker.com/casjaysdevdocker/jekyll"
LABEL org.opencontainers.image.source="https://hub.docker.com/casjaysdevdocker/jekyll"
